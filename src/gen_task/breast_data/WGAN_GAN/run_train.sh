...
#SBATCH --job-name=wgan128_cross            # Job name
#SBATCH -o train_cross_128_200k.%N.%j.out           # File containing STDOUT output
#SBATCH -e train_cross_128_200k.%N.%j.err           # File containing STDERR output
