...
#SBATCH --job-name=hagan_256     # Job name
#SBATCH -o HAGAN_train_256.%N.%j.out           # File containing STDOUT output
#SBATCH -e HAGAN_train_256.%N.%j.err           # File containing STDERR output
