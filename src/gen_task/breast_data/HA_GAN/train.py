...
parser.add_argument('--continue-iter', default=90000, type=int,
...
parser.add_argument('--lr-g', default=0.0002, type=float,
...
parser.add_argument('--exp-name', default='HA_GAN_256_true', type=str,
...
def main():
    ...
    trainset = Dataset_Duke()               #cross dataset (METABREST and DUKE)
