...
class VQGAN(pl.LightningModule):
    def __init__(self, cfg):
        ...
        #self.log_frequency = cfg.model.log_frequency
    ...
    def forward(self, x, optimizer_idx=None, log_image=False):
        ...
        if optimizer_idx == 0:
            ...
            self.log("train/recon_loss", recon_loss, prog_bar=False,
                     logger=True, on_step=False, on_epoch=True)
            self.log("train/aeloss", aeloss, prog_bar=False,
                     logger=True, on_step=False, on_epoch=True)
        ...
        if optimizer_idx == 1:
            ...
            self.log("train/d_video_loss", d_video_loss,
                     logger=True, on_step=False, on_epoch=True)
            self.log("train/discloss", discloss, prog_bar=False,
                     logger=True, on_step=False, on_epoch=True)
            return discloss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val/recon_loss', recon_loss, prog_bar=False)
        self.log('val/perceptual_loss', perceptual_loss, prog_bar=False)
        self.log('val/perplexity', vq_output['perplexity'], prog_bar=False)
