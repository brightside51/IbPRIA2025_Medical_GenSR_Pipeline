...
#SBATCH --job-name=tes_aw128_cross       # Job name
#SBATCH -o test_128.%N.%j.out           # File containing STDOUT output
#SBATCH -e test_128.%N.%j.err           # File containing STDERR output
