...
#SBATCH --job-name=debug_dataset       # Job name
#SBATCH -o debug_test_128.%N.%j.out           # File containing STDOUT output
#SBATCH -e debug_test_128.%N.%j.err           # File containing STDERR output
