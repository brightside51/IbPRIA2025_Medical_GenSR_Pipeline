...
#SBATCH --job-name=VTT_preparation            # Job name
#SBATCH -o VTT_preparation.%N.%j.out           # File containing STDOUT output
#SBATCH -e VTT_preparation.%N.%j.err           # File containing STDERR output
