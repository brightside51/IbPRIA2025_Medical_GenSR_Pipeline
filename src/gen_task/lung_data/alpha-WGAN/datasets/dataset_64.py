...
class Dataset_LIDC(Dataset):
    ...
    def normalize_dicom_pixels(self, dicom_data, maxHU=400., minHU=-1000.):
        ...
        # Update the pixel array of the DICOM dataset with normalized values
        dicom_data.PixelData = (normalized_pixel_data * dicom_data.pixel_array.max()).astype(dicom_data.pixel_array.dtype)
