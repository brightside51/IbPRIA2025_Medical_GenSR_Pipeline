...
#SBATCH --job-name=test_WGAN_64       # Job name
#SBATCH -o test_200k_64.%N.%j.out           # File containing STDOUT output
#SBATCH -e test_200k_64.%N.%j.err           # File containing STDERR output
