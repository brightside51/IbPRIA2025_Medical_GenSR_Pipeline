...
trainset = Dataset_LIDC(path_slurm, image_size=size_slices)
...
G.load_state_dict(torch.load('/nas-ctm01/homes/jamartins/joao-a-martins/joao-a-martins-msc/LIDC/joao_processing/WGAN/scripts/64x64/checkpoint_64_200k/G_2_iter150001.pth'))
D.load_state_dict(torch.load('/nas-ctm01/homes/jamartins/joao-a-martins/joao-a-martins-msc/LIDC/joao_processing/WGAN/scripts/64x64/checkpoint_64_200k/D_2_iter150001.pth'))
...
for iteration in range(TOTAL_ITER):
    ...
    # Model Save
    ###############################################
    directory_path = "checkpoint_64_200k"

    if not os.path.exists(directory_path):
        os.makedirs(directory_path)
    if iteration % 10000 == 0:
        torch.save(G.state_dict(), f'checkpoint_64_200k/G_2_iter{iteration+1}.pth')
        torch.save(D.state_dict(), f'checkpoint_64_200k/D_2_iter{iteration+1}.pth')
        print("Saved model")
...
plt.legend()
plt.savefig('D_loss_plot_200k.png')
plt.close()
...
plt.legend()
plt.savefig('G_loss_plot_200k.png')
plt.close()
