...
#SBATCH --job-name=test_WGAN_128       # Job name
#SBATCH -o test_200k_128.%N.%j.out           # File containing STDOUT output
#SBATCH -e test_200k_128.%N.%j.err           # File containing STDERR output
