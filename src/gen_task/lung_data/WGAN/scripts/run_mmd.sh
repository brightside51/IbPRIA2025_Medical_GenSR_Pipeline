...
#SBATCH --job-name=mmd_WGAN_64           # Job name
#SBATCH -o mmd_WGAN_64.%N.%j.out           # File containing STDOUT output
#SBATCH -e mmd_WGAN_64.%N.%j.err           # File containing STDERR output

echo "Running job in reserved partition"

# Commands / scripts to run (e.g., python3 train.py)
# (...)
python3 ../metrics/mmd.py